    ...
    <section className="relative flex h-screen w-full items-center justify-center overflow-hidden">
      <div className="absolute inset-0">
        <img loading="eager" decoding="async" fetchpriority="high"
          ...
          alt="Subasta de caballos de polo en Total Equines, Argentina"
    ...
    <section className="section-padding section-tint">
      <div className="container-custom">
        <AnimatedSection className="mb-12 text-center">
          ...
          <h2 className="font-display uppercase text-4xl sm:text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.faq_title')}</h2>
        </AnimatedSection>
    ...
    <section className="section-padding bg-transparent">
      ...
      <div className="container-custom">
        <AnimatedSection className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-display uppercase text-3xl sm:text-5xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.newsletter_title')}</h2>
      ...
      <section className="section-padding bg-transparent">
        <div className="container-custom">
          <AnimatedSection className="mb-12">
            ...
            <h2 className="font-display uppercase text-4xl sm:text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.upcoming_title')}</h2>
          </AnimatedSection>
          ...
          {closed.length > 0 && (
            <>
              <AnimatedSection className="mb-12 mt-20">
                ...
                <h2 className="font-display uppercase text-4xl sm:text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.past_title')}</h2>
              </AnimatedSection>
