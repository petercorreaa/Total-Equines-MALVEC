  ...
  return (
    <section className="relative flex h-screen w-full items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.h1 variants={fadeUp} className="font-display uppercase text-6xl tracking-[0.08em] text-white sm:text-8xl lg:text-9xl" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>
    ...
    <section className="section-padding section-tint">
      <div className="container-custom">
        <AnimatedSection className="mb-12 text-center">
          ...
          <h2 className="font-display uppercase text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.faq_title')}</h2>
        </AnimatedSection>
            ...
            return (
              <div key={i} className="border-b border-gray-800">
                ...
                >
                  ...
                  <span className="ml-4 flex-shrink-0 font-display uppercase text-2xl text-gold" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>
                    {isOpen ? '−' : '+'}
                  </span>
                </button>
    ...
    <section className="section-padding bg-transparent">
      ...
      <div className="container-custom">
        <AnimatedSection className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="font-display uppercase text-5xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.newsletter_title')}</h2>
      ...
      <section className="section-padding bg-transparent">
        <div className="container-custom">
          <AnimatedSection className="mb-12">
            ...
            <h2 className="font-display uppercase text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.upcoming_title')}</h2>
          </AnimatedSection>
          ...
          {closed.length > 0 && (
            <>
              <AnimatedSection className="mb-12 mt-20">
                ...
                <h2 className="font-display uppercase text-6xl text-white" style={{ fontFamily: 'Couture, sans-serif', textTransform: 'uppercase' }}>{t('subastas.past_title')}</h2>
              </AnimatedSection>
