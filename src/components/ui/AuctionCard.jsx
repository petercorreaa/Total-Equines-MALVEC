        ...
        <div className="p-4 sm:p-8">
          ...
          {isClosed && auction.results ? (
            <div className="mt-6 rounded-2xl border border-gray-700 bg-white/[0.04] p-6">
              ...
              <div className="mt-4">
                <p className="font-display uppercase text-3xl text-white" style={{ fontFamily: 'Couture, sans-serif', fontWeight: 700, textTransform: 'uppercase', WebkitTextStroke: '0.015em currentColor', fontSynthesis: 'none' }}>
